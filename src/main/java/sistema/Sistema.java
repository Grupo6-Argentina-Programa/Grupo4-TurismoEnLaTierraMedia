	...
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			case 2:
				...
				System.out.println("Ingrese 4 -> Para aÒdir mas dinero.");
				System.out.println("Ingrese 5 -> Para aÒdir mas tiempo.");
	...
	public void exportarUsuarios() throws IOException {
		...
		for (Usuario usuario : usuarios) {
			...
			printWriter.println("El usuario DNI: " + usuario.getId() + ", le gustan las atracciones del tipo de "
					+ usuario.getTipoFavorito().toString() + ", ingres√≥ con " + usuario.getDineroInicial()
					+ " monedas y " + usuario.getTiempoInicial() + " horas inicialmente, se retir√≥ con "
					+ usuario.getDineroDisponible() + " monedas disponibles y " + usuario.getTiempoDisponible()
					+ " horas disponibles. Gast√≥ " + usuario.getCostoTotal() + " monedas y estuvo " + tiempoOcupado
