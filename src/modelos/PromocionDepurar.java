...
public abstract class PromocionDepurar implements Comparable<PromocionInterface>, PromocionInterface{
    ...
    public PromocionDepurar(int id,int tipo, Atraccion atraA, Atraccion atraB, int atraP, String porcentaje,String total) throws Exception{
    ...
    public boolean equals(Object o) {
        ...
        PromocionDepurar promocion = (PromocionDepurar) o;
