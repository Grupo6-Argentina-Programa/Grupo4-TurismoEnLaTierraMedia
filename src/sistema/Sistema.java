...
public class Sistema {
	...
	private final List<PromocionInterface> promociones;
	...
	public Sistema(String directorioUsuariosCSV, String directorioAtraccionesCSV, String directorioPromocionesCSV)
		...
		atracciones.sort(new AtraccionComparador());
...
//----------------------------------------------------------------------------//
	...
	public Sistema(List<Usuario> usuarios, List<Atraccion> atracciones, List<PromocionInterface> promociones)
			throws IOException {
		this.usuarios = usuarios;
		this.atracciones = atracciones;
		this.promociones = promociones;
		this.atracciones.sort(new AtraccionComparador());
		this.promociones.sort(new PromocionComparador());
...
//----------------------------------------------------------------------------//
	...
	public List<PromocionInterface> getPromociones() {
		return promociones;
	}
}
